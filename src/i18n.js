...
const I18N = {
  zh: {
    ...
    "editor.dropFormats": "支持 PNG / JPG / PDF / DOCX（可多选）",
    "editor.recognize": "开始识别",
    "editor.recognizingBatch": "识别中 {done}/{total}…",
    "editor.batchComplete": "完成：成功 {success}，失败 {failed}",
    "editor.allFailed": "全部上传失败",
    "editor.failedList": "上传失败：",
    "editor.closeTab": "关闭",
    ...
    "settings.aiDesc": "配置兼容 OpenAI 规范的 AI 接口（如 Qwen-VL、Claude、DeepSeek）。识图和图示识别需模型具备多模态能力（如 GPT-4V、Claude 3+、Qwen-VL 等）。",
    "settings.apiKey": "API Key",
    "settings.baseUrl": "Base URL",
    "settings.modelName": "Model Name",
    "settings.modelPh": "如 qwen-vl-max / gpt-4o",
    "settings.effort": "推理强度",
    "settings.effortHint": "档位越高越准但更慢。各模型支持的档位不同：点「检测可用档位」会真的逐档试一次，据此标出该模型支持哪些档位；选了不支持的档位会自动降到最接近的可用档位。注意：xhigh / max 在长题目上可能耗时数分钟甚至被上游网关中断，日常用 high 一般就够。",
    "settings.effortAuto": "自动（不指定，由模型默认）",
    "settings.fetchModels": "获取模型列表",
    "settings.modelsLoaded": "已获取 {n} 个模型，点输入框可下拉选择",
    "settings.modelsEmpty": "上游没有返回任何模型，请手动填写模型名",
    "settings.modelsFailed": "获取模型列表失败：{msg}",
    "settings.probeEffort": "检测可用档位",
    "settings.probing": "检测中…",
    "settings.probingHint": "正在逐档试探，需要十几秒…",
    "settings.probeDone": "检测完成：该模型支持 {list}",
    "settings.probeNone": "（无可用档位，将不发送该参数）",
    "settings.probeUnclear": "结论不明：{list}",
    "settings.probeFailed": "检测失败：{msg}",

    "effort.none": "关闭（none）",
    "effort.minimal": "最低（minimal）",
    "effort.low": "低（low）",
    "effort.medium": "中（medium）",
    "effort.high": "高（high，推荐）",
    "effort.xhigh": "极高（xhigh）",
    "effort.max": "最高（max）",
    "effort.unsupportedSuffix": "· 该模型可能不支持",
    "effort.source.probe": "档位来自实测检测结果，最准。",
    "effort.source.learned": "档位来自实际调用中的反馈（曾被上游拒绝的档位已排除）。",
    "effort.source.catalog": "档位来自已知模型表，可能过时；建议点「检测可用档位」实测一次。",
    "effort.source.default": "尚未检测该模型可用档位，先按全部档位列出；若上游拒绝会自动降级。",
    "effort.willDegrade": "所选档位不被支持，实际会用 {level}。",
    "effort.mayDegrade": "所选档位可能不被支持，届时会自动降到最接近的可用档位。",
    ...
    "export.includeImage": "含图",
    "export.includeImageTitle": "在导出文件中嵌入原始扫描图片",
    ...
    "detail.regenAnswer": "重新生成",
    "detail.answerCorrectPh": "如：第二步的符号错了，重新算一下",
    "detail.answerCorrectBtn": "提交修正",
    "detail.answerCorrectHint": "用自然语言说明哪里不对，AI 会基于当前解答改；点「重新生成」则换一种思路重解。",
    "detail.answerCorrecting": "AI 修正中，请稍候…",
    "detail.answerCorrected": "已按你的要求修正 ✓",
    "detail.answerRegenerated": "已重新生成 ✓",
    "detail.aiGenerating": "AI 生成中，请稍候…",
    "detail.aiGenerated": "已生成 ✓",
    "detail.aiGenFailed": "生成失败：{msg}",
    "detail.subject": "学科：",
    "detail.subjectFailed": "修改学科失败：{msg}",
    "detail.tags": "标签：",
    "detail.tagPh": "添加标签…",
    "detail.addTag": "添加",
  ...
  en: {
    ...
    "questionType.mc": "MC",
    "questionType.tf": "T/F",
    "questionType.saq": "Short",
    "questionType.laq": "Long",

    "editor.dropText": "Drag files here, or ",
    "editor.dropClick": "click to choose",
    "editor.dropFormats": "Supports PNG / JPG / PDF / DOCX (multiple files allowed)",
    "editor.recognize": "Recognize",
    "editor.recognizingBatch": "Processing {done}/{total}…",
    "editor.batchComplete": "Done: {success} succeeded, {failed} failed",
    "editor.allFailed": "All uploads failed",
    "editor.failedList": "Failed uploads:",
    ...
    "settings.aiDesc": "Configure any OpenAI-compatible AI endpoint (Qwen-VL, Claude, DeepSeek…). Image recognition and diagram detection require a multimodal model (e.g. GPT-4V, Claude 3+, Qwen-VL).",
    "settings.apiKey": "API Key",
    "settings.baseUrl": "Base URL",
    "settings.modelName": "Model Name",
    "settings.modelPh": "e.g. qwen-vl-max / gpt-4o",
    "settings.effort": "Reasoning effort",
    "settings.effortHint": "Higher effort is more accurate but slower. Supported levels vary by model: “Detect levels” actually tries each one and marks what this model accepts. Picking an unsupported level falls back to the closest available one. Note: xhigh / max can take several minutes on long problems and may be cut off by the upstream gateway — high is usually enough.",
    "settings.effortAuto": "Auto (leave to the model)",
    "settings.fetchModels": "Fetch models",
    "settings.modelsLoaded": "Loaded {n} models — click the field to pick one",
    "settings.modelsEmpty": "The endpoint returned no models; type the name manually.",
    "settings.modelsFailed": "Failed to fetch models: {msg}",
    "settings.probeEffort": "Detect levels",
    "settings.probing": "Detecting…",
    "settings.probingHint": "Trying each level, this takes ~10-20s…",
    "settings.probeDone": "Detected: this model supports {list}",
    "settings.probeNone": "(no level accepted — the parameter will be omitted)",
    "settings.probeUnclear": "Inconclusive: {list}",
    "settings.probeFailed": "Detection failed: {msg}",

    "effort.none": "None (off)",
    "effort.minimal": "Minimal",
    "effort.low": "Low",
    "effort.medium": "Medium",
    "effort.high": "High (recommended)",
    "effort.xhigh": "Extra high (xhigh)",
    "effort.max": "Max",
    "effort.unsupportedSuffix": "· may be unsupported",
    "effort.source.probe": "Levels come from a real detection run — most reliable.",
    "effort.source.learned": "Levels inferred from real calls (levels the endpoint rejected are excluded).",
    "effort.source.catalog": "Levels come from a built-in model table and may be outdated — run “Detect levels” to be sure.",
    "effort.source.default": "This model has not been probed yet, so all levels are listed. Unsupported ones degrade automatically.",
    "effort.willDegrade": "This level is unsupported — {level} will be sent instead.",
    "effort.mayDegrade": "This level may be unsupported; it will fall back to the closest available one.",
    ...
    "export.includeImage": "Include image",
    "export.includeImageTitle": "Embed the original scanned image in the export",
    ...
    "detail.regenAnswer": "Regenerate",
    "detail.answerCorrectPh": "e.g. the sign in step 2 is wrong, redo it",
    "detail.answerCorrectBtn": "Apply correction",
    "detail.answerCorrectHint": "Describe what's wrong in plain language and the AI revises the current solution; “Regenerate” solves it again from a different angle.",
    "detail.answerCorrecting": "AI is correcting, please wait…",
    "detail.answerCorrected": "Corrected as requested ✓",
    "detail.answerRegenerated": "Regenerated ✓",
    "detail.aiGenerating": "AI is generating, please wait…",
    "detail.aiGenerated": "Generated ✓",
    "detail.aiGenFailed": "Generation failed: {msg}",
    "detail.subject": "Subject:",
    "detail.subjectFailed": "Failed to change subject: {msg}",
    "detail.tags": "Tags:",
